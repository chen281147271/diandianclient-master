...
{
    public partial class ReservationOrderControl : UserControl
    {
        Biz.BizBillController billController = new Biz.BizBillController();
        List<Models.dd_book_orders> list;
        public int curPage = 1;
        public int pageSize = 10;
        public int allcount = 0;
        public ReservationOrderControl()
        {
            string str = "2018-01-01";
            DateTime strdt = Convert.ToDateTime(str);
            list = billController.QueryOrderList("", 0, strdt, DateTime.Now);
            InitializeComponent();
            IniData();
        }
        public class cfmain
