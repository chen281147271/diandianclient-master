...
namespace DianDianClient.MyControl.More.jinxiaocunManage
{
    public partial class kucunControl : UserControl
    {
        ...
        private void BindGrid(bool singlePage = true)//单页，所有     
        {
            ...
            string crudename = Txt_shangpinName.Text;
            ...
            this.list = BizStorage.QueryStock(itemname,categoryname,crudename,genreid,sdate,edate);
            var q = (list);
            if (singlePage)
            {
        ...
        private void repositoryItemButtonEdit1_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            DateTime validate = Convert.ToDateTime(this.gridView1.GetRowCellValue(rowhandle, "validate"));
            if (e.Button.Index == 1)
            {
                MyForm.More.jinxiaocunManage.EditkuncunForm editkuncun = new MyForm.More.jinxiaocunManage.EditkuncunForm(crudeid, validate);
                editkuncun.StartPosition = FormStartPosition.CenterScreen;
                editkuncun.ShowDialog();
            }
            RefreshGridList();
        }
    }
