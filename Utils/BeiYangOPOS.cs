...
namespace PosPrintService
{
    ...
    public class BeiYangOPOS
    {
        ...
        {
            System.Net.IPAddress ServeIP = System.Net.IPAddress.Parse(a_strNetIP);
            System.Net.IPEndPoint remoteEP = new System.Net.IPEndPoint(ServeIP, Int32.Parse(a_strPort));
            System.Net.Sockets.Socket clientSocket = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp);
            try
            {
