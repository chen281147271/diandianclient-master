                        ...
                        if (PnPEntityCollection != null)
                        {
                            foreach (ManagementObject Entity in PnPEntityCollection)
                            {
                                try {
                                    ...
                                    //String Antecedent = (Entity["DeviceID"] as String);
                                    //Console.WriteLine("aa:" + Antecedent);
                                    ...
                                    if ((Entity["Name"] != null && Entity["Name"].ToString().IndexOf("USB 打印支持") >= 0)|| (Entity["Name"] != null && Entity["Name"].ToString().IndexOf("USB Printing") >= 0))
                                        UsbDevices.Add(Element);
                                } catch (Exception  ex) {
                                    // MessageBox.Show("打印机  " + ex.Message);
                                    Console.WriteLine("打印机1：{0}",ex);
                                }
